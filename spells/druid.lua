function getDruidSpells()
	return {
		...
		[16855] = { name = "Faerie Fire (Bear)", rank = 1, duration = 40 },
		[17387] = { name = "Faerie Fire (Bear)", rank = 2, duration = 40 },
		[17388] = { name = "Faerie Fire (Bear)", rank = 3, duration = 40 },
		[17389] = { name = "Faerie Fire (Bear)", rank = 4, duration = 40 },

		[16857] = { name = "Faerie Fire (Feral)", rank = 1, duration = 40 },
		[17390] = { name = "Faerie Fire (Feral)", rank = 2, duration = 40 },
		[17391] = { name = "Faerie Fire (Feral)", rank = 3, duration = 40 },
		[17392] = { name = "Faerie Fire (Feral)", rank = 4, duration = 40 },

		[2637] = { name = "Hibernate", rank = 1, duration = 20 },
		[18657] = { name = "Hibernate", rank = 2, duration = 30 },
		[18658] = { name = "Hibernate", rank = 3, duration = 40 },

		[5570] = { name = "Insect Swarm", rank = 1, duration = 12 },
		[24974] = { name = "Insect Swarm", rank = 2, duration = 12 },
		[24975] = { name = "Insect Swarm", rank = 3, duration = 12 },
		[24976] = { name = "Insect Swarm", rank = 4, duration = 12 },
		[24977] = { name = "Insect Swarm", rank = 5, duration = 12 },
		...
		[1079] = { name = "Rip", rank = 1, duration = 12 },
		[9492] = { name = "Rip", rank = 2, duration = 12 },
		[9493] = { name = "Rip", rank = 3, duration = 12 },
		[9752] = { name = "Rip", rank = 4, duration = 12 },
		[9894] = { name = "Rip", rank = 5, duration = 12 },
		[9896] = { name = "Rip", rank = 6, duration = 12 },

		[2908] = { name = "Soothe Animal", rank = 1, duration = 15 },
		[8955] = { name = "Soothe Animal", rank = 2, duration = 15 },
		[9901] = { name = "Soothe Animal", rank = 3, duration = 15 },

		[5211] = { name = "Bash", rank = 1, duration = 2 },
		[6798] = { name = "Bash", rank = 2, duration = 3 },
		[8983] = { name = "Bash", rank = 3, duration = 4 },

		[22570] = { name = "Maim", rank = 1, duration = 5 },
		[49802] = { name = "Maim", rank = 2, duration = 5 },
		[49803] = { name = "Maim", rank = 3, duration = 5 },
		...
		[5209] = { name = "Challenging Roar", rank = 1, duration = 6 },
	}
end

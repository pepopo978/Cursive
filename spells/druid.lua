...
function getDruidSpells()
	return {
		...
		[5570] = { name = L["Insect Swarm"], rank = 1, duration = 12 },
		[24974] = { name = L["Insect Swarm"], rank = 2, duration = 12 },
		[24975] = { name = L["Insect Swarm"], rank = 3, duration = 12 },
		[24976] = { name = L["Insect Swarm"], rank = 4, duration = 12 },
		[24977] = { name = L["Insect Swarm"], rank = 5, duration = 12 },

		[8921] = { name = L["Moonfire"], rank = 1, duration = 9 },
		[8924] = { name = L["Moonfire"], rank = 2, duration = 12 },
		[8925] = { name = L["Moonfire"], rank = 3, duration = 12 },
		[8926] = { name = L["Moonfire"], rank = 4, duration = 12 },
		[8927] = { name = L["Moonfire"], rank = 5, duration = 12 },
		[8928] = { name = L["Moonfire"], rank = 6, duration = 12 },
		[8929] = { name = L["Moonfire"], rank = 7, duration = 12 },
		[9833] = { name = L["Moonfire"], rank = 8, duration = 12 },
		[9834] = { name = L["Moonfire"], rank = 9, duration = 12 },
		[9835] = { name = L["Moonfire"], rank = 10, duration = 12 },

		[1822] = { name = L["Rake"], rank = 1, duration = 9 },
		[1823] = { name = L["Rake"], rank = 2, duration = 9 },
		[1824] = { name = L["Rake"], rank = 3, duration = 9 },
		[9904] = { name = L["Rake"], rank = 4, duration = 9 },

		[1079] = { name = L["Rip"], rank = 1, duration = 12 },
		[9492] = { name = L["Rip"], rank = 2, duration = 12 },
		[9493] = { name = L["Rip"], rank = 3, duration = 12 },
		[9752] = { name = L["Rip"], rank = 4, duration = 12 },
		[9894] = { name = L["Rip"], rank = 5, duration = 12 },
		[9896] = { name = L["Rip"], rank = 6, duration = 12 },
		...
		[22570] = { name = L["Maim"], rank = 1, duration = 5 },
		[49802] = { name = L["Maim"], rank = 2, duration = 5 },
		[49803] = { name = L["Maim"], rank = 3, duration = 5 },

...
function getDruidSpells()
	return {
		...
		[5570] = { name = L["Insect Swarm"], rank = 1, duration = 12, variable_duration = true },
		[24974] = { name = L["Insect Swarm"], rank = 2, duration = 12, variable_duration = true },
		[24975] = { name = L["Insect Swarm"], rank = 3, duration = 12, variable_duration = true },
		[24976] = { name = L["Insect Swarm"], rank = 4, duration = 12, variable_duration = true },
		[24977] = { name = L["Insect Swarm"], rank = 5, duration = 12, variable_duration = true },

		[8921] = { name = L["Moonfire"], rank = 1, duration = 9, variable_duration = true },
		[8924] = { name = L["Moonfire"], rank = 2, duration = 12, variable_duration = true },
		[8925] = { name = L["Moonfire"], rank = 3, duration = 12, variable_duration = true },
		[8926] = { name = L["Moonfire"], rank = 4, duration = 12, variable_duration = true },
		[8927] = { name = L["Moonfire"], rank = 5, duration = 12, variable_duration = true },
		[8928] = { name = L["Moonfire"], rank = 6, duration = 12, variable_duration = true },
		[8929] = { name = L["Moonfire"], rank = 7, duration = 12, variable_duration = true },
		[9833] = { name = L["Moonfire"], rank = 8, duration = 12, variable_duration = true },
		[9834] = { name = L["Moonfire"], rank = 9, duration = 12, variable_duration = true },
		[9835] = { name = L["Moonfire"], rank = 10, duration = 12, variable_duration = true },
